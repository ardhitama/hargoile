...
double hgl::vectorDistance(double lat1, double lon1, double alt1, double lat2, double lon2, double alt2)
{
	lat1 = degToRad(lat1);
	lon1 = degToRad(lon1);
	lat2 = degToRad(lat2);
...
double hgl::greatCircleDistanceHaversine(double lat1, double lon1, double lat2, double lon2)
{
	// ellipsoid defining parameters according WGS84
...
// unit is in meters
double hgl::geodeticDistance(double lat1, double lon1, double alt1, double lat2, double lon2, double alt2)
{
